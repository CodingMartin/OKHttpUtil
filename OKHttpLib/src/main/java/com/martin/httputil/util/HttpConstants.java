...
public class HttpConstants {
    ...
    public static final String BASE_URL = "http://120.76.76.191:8134/router";

    public static final String UTF8 = "UTF-8";
    public static final String SECRET = "MQ-Android";//"themis-opf-test";
    public static final String APP_KEY = "OPF-JHD-MQ-Android";//"T-OPF-02191317";
    ...
    public static final int BusinessIdTieZi = 12001;
    public static final int BusinessIdBanner = 13001;

    public static final int FileTypeImage = 1;
    public static final int FileTypeVideo = 2;
    public static final int FileTypeOther = 3;

    public static final String AppId = "MQ-Android";
    /**
     * 上传图片
     **/
